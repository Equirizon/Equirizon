  ...
  return (
    <DropdownMenuProvider>
      ...
      <DropdownMenuContent className='mx-2 bg-linear-60 from-fuchsia-100/50 to-sky-100/50 shadow-md backdrop-blur-lg'>
        ...
        <DropdownMenuItem>Hobbies</DropdownMenuItem>
        <DropdownMenuItem>Contact</DropdownMenuItem>
        <DropdownMenuSeparator />
        <div className='flex flex-row items-center justify-between'>
          <DropdownMenuItem>
            <a href='https://github.com/Equirizon' target='_blank' rel='noopener noreferrer'>
              <svg
                width='15'
                height='15'
                viewBox='0 0 15 15'
          ...
          <DropdownMenuItem>
            <a href='https://linkedin.com/in/donbustria/' target='_blank' rel='noopener noreferrer'>
              <svg
                width='15'
                height='15'
                viewBox='0 0 15 15'
          ...
          <DropdownMenuItem>
            <a href='https://soundcloud.com/equirizon' target='_blank' rel='noopener noreferrer'>
